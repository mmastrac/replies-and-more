...
document.querySelector('.addthis_toolbox').setAttribute('addthis:title', shareData.title);
document.querySelector('.addthis_toolbox').setAttribute('addthis:description', shareData.description);
